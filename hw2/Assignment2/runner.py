...
from old import implementation1 as imp
...
def load_data(path='./data/train'):
    ...
    file_list = glob.glob(os.path.join(dir, path + '/pos/*')) #0 - 12499
    file_list.extend(glob.glob(os.path.join(dir, path + '/neg/*'))) # 12500 - 24999
